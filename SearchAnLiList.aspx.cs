...
public partial class SearchAnLiList : System.Web.UI.Page
{
    ...
    private void gvbind()
    {
        ...
        string sql = "select   *   from   AnLi   where   1=1";
        if (ShangPinName != "")
        {
            sql += " and   AnLiName   like   '%" + ShangPinName + "%'   ";

        }
        if (ShangPinTypeName != "所有类别")
        {
            sql += " and   AnLiTypeName   like   '%" + ShangPinTypeName + "%'   ";
        }
