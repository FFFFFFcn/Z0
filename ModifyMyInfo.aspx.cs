...
public partial class ModifyMyInfo : System.Web.UI.Page
{
    ...
    {
        string id = Session["UserId"].ToString();
        data.RunSql("update  Users set UserName='" + txtname.Text + "',XingMing='" + XingMing.Text + "',Age='" + Age.Text + "',Ds='" + txtds.Text + "',emal='" + txtemal.Text + "',Tel='" + Tel.Text + "',Address='" + Address.Text + "',Photo='" + pic.Text + "' where id=" + id);
